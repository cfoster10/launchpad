CREATE TYPE "public"."background" AS ENUM('non_technical', 'some_coding', 'developer');--> statement-breakpoint
CREATE TYPE "public"."role" AS ENUM('building_myself', 'leading_team', 'learning');--> statement-breakpoint
CREATE TYPE "public"."template_id" AS ENUM('business_tool', 'ecommerce', 'community', 'saas', 'custom');--> statement-breakpoint
